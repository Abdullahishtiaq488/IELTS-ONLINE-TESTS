                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
                    ...
                    <div className="md:col-span-4">
                        <nav className="space-y-3">
                            <Link href="/contact" className="block hover:text-secondary-300">Contact Us</Link>
                            <Link href="/privacy" className="block hover:text-secondary-300">Privacy Policy</Link>
                            <Link href="/sitemap" className="block hover:text-secondary-300">Site Map</Link>
                            <Link href="/faq" className="block hover:text-secondary-300">Frequently Asked Questions</Link>
                            <Link href="/terms" className="block hover:text-secondary-300">Terms & Conditions</Link>
                            <Link href="/testimonials" className="block hover:text-secondary-300">Testimonials</Link>
                            <Link href="/careers" className="block hover:text-secondary-300">Careers</Link>
                        </nav>

                        <div className="mt-6 flex flex-col gap-3">
                            <div className="relative inline-block w-44">
                                <select className="block appearance-none w-full bg-muted-100 border border-muted-300 text-black py-2 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white" aria-label="Currency selector">
                                    <option>PKR ₨</option>
                                    <option>USD $</option>
                                    <option>EUR €</option>
                                    <option>GBP £</option>
                            ...
                            <div className="relative inline-block w-44">
                                <select className="block appearance-none w-full bg-muted-100 border border-muted-300 text-primary-900 py-2 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white" aria-label="Language selector">
                    ...
                    <div className="md:col-span-8">
                        ...
                        <div className="mb-8">
                            ...
                            <div className="flex space-x-4">
                                <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="hover:opacity-80" aria-label="Follow us on Facebook">
                                ...
                                <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="hover:opacity-80" aria-label="Follow us on YouTube">
                                    <div className="bg-white rounded-full p-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 text-primary-900" aria-hidden="true">
