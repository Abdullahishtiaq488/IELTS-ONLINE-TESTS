    ...
    return (
        <footer className="bg-primary-950 text-white pt-12 pb-6">
            <Container>
                    ...
                    <div className="md:col-span-4">
                        ...
                        <div className="mt-6 flex flex-col gap-3">
                            <div className="relative inline-block w-44">
                                <select className="block appearance-none w-full bg-muted-100 border border-muted-300 text-black py-2 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white">
                                    <option>PKR ₨</option>
                                    <option>USD $</option>
                                    <option>EUR €</option>
                                    <option>GBP £</option>
                            ...
                            <div className="relative inline-block w-44">
                                <select className="block appearance-none w-full bg-muted-100 border border-muted-300 text-primary-900 py-2 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white">
                            ...
                            <div className="flex space-x-4">
                                <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="hover:opacity-80">
                                    <div className="bg-white rounded-full p-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 text-primary-900">
                ...
                <div className="border-t border-muted-700 pt-6 mt-6 text-xs text-muted-950">
