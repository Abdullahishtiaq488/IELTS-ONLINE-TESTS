    ...
    return (
        <footer className="bg-blue-950 text-white pt-12 pb-6">
            <Container>
                <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
                    ...
                    <div className="md:col-span-4">
                        <nav className="space-y-3">
                            ...
                            <Link href="/sitemap" className="block hover:text-gray-300">Site Map</Link>
                            ...
                            <Link href="/careers" className="block hover:text-gray-300">Careers</Link>
                        </nav>

                        <div className="mt-6 flex flex-col gap-3">
                            <div className="relative inline-block w-44">
                                <select className="block appearance-none w-full bg-gray-100 border border-gray-300 text-blue-900 py-2 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white">
                                    <option>PKR ₨</option>
                                    <option>USD $</option>
                                    <option>EUR €</option>
                                    <option>GBP £</option>
                ...
                <div className="border-t border-gray-700 pt-6 mt-6 text-xs text-gray-400">
