                        ...
                        <div className="bg-white rounded-lg my-3 sm:my-4 p-3 sm:p-4 hover:shadow-lg transition-shadow overflow-hidden">
                            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                                ...
                                <div className="flex-1 min-w-0">
                                    <h3 className="text-base sm:text-lg font-semibold text-secondary-900 mb-1 line-clamp-2 sm:line-clamp-1">
                                        {tip.title}
                                    </h3>
                                    <div className="flex items-center gap-1 sm:gap-2 mb-1">
                                        <div className="flex">{renderStars(tip.rating)}</div>
                                        <span className="text-sm text-secondary-600">({tip.votes} votes)</span>
                                    </div>
                                    <div className="flex flex-wrap items-center text-xs sm:text-sm text-secondary-500 mb-2">
                                    ...
                                    <p className="text-xs sm:text-sm text-secondary-600 line-clamp-2 sm:line-clamp-3">
                                        {tip.description}
                                    </p>
                                </div>
                            </div>
