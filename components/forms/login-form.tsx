            ...
            <div className="md:flex md:space-x-12">
                ...
                <div className="md:w-1/2">
                    ...
                    <form onSubmit={handleSubmit} aria-label="Login form">
                        ...
                        <div className="text-center mt-4">
                            <Link href="/forgot-password" className="text-primary-500 hover:text-primary-700 text-sm" aria-label="Forgot password">
                                Forgot password?
                            </Link>
                        </div>
                    </form>
                ...
                <div className="md:w-1/2">
                    <div className="space-y-4 h-full flex flex-col justify-center">
                        <button 
                            type="button"
                            className="w-full flex items-center justify-center bg-red-500 hover:bg-red-600 text-white py-3 rounded-md"
