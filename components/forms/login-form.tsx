        ...
        <div className={showHeader ? "max-w-md mx-auto bg-white rounded-lg shadow-md p-8 md:max-w-4xl" : "w-full"}>
            {showHeader && (
                <>
                    ...
                    <h1 className="text-2xl font-bold text-center text-blue-900 mb-8">LOG IN TO YOUR ACCOUNT</h1>
                </>
            )}
            ...
            <div className="md:flex md:space-x-12">
                ...
                <div className="md:w-1/2">
                    ...
                    <div className="flex mb-6 border-b border-gray-200">
                        <button
                            className={`flex items-center pb-3 px-4 ${loginMethod === 'phone' ? 'border-b-2 border-blue-500 text-blue-500' : 'text-gray-500'}`}
                        ...
                        <button
                            className={`flex items-center pb-3 px-4 ${loginMethod === 'email' ? 'border-b-2 border-blue-500 text-blue-500' : 'text-gray-500'}`}
                ...
                <div className="md:w-1/2">
                    <div className="space-y-4 h-full flex flex-col justify-center">
                        ...
                        <button className="w-full flex items-center justify-center bg-blue-600 hover:bg-blue-700 text-white py-3 rounded-md">
                            <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <button className="w-full flex items-center justify-center bg-blue-400 hover:bg-blue-500 text-white py-3 rounded-md">
                            <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
