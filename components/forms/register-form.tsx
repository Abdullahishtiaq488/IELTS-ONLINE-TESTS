        ...
        <div className={showHeader ? "max-w-md mx-auto bg-white rounded-lg shadow-md p-8 md:max-w-4xl" : "w-full"}>
            {showHeader && (
                <>
                    ...
                    <h1 className="text-2xl font-bold text-center text-blue-900 mb-8">CREATE AN ACCOUNT</h1>
                </>
            )}
            ...
            {showHeader && (
                <div className="text-center mt-8">
                    <p>
                        ...
                        <Link href="/terms" className="text-blue-900 font-medium">Terms of Use</Link> and{' '}
